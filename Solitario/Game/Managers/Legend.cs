...
internal class Legend {
  ...
  private static readonly string[] selectTexts = { "Seleziona elemento/i", "Posiziona" };
  ...
  private static string deselectText = "Deseleziona elemento/i";
  ...
  internal void Draw() {
    ...
    Console.Write(
        ...
        $"\u001b[1;34m║\u001b[0m  \u001b[1;33m(R)\u001b[0m \u001b[1;36m{pickCardText}\u001b[0m{new string(' ', legendWidth - 2 - 6 - pickCardText.Length)}\u001b[1;34m║\n" +
        $"\u001b[1;34m║\u001b[0m  \u001b[1;33m(T)\u001b[0m \u001b[1;36m{pickWasteText}\u001b[0m{new string(' ', legendWidth - 2 - 6 - pickWasteText.Length)}\u001b[1;34m║\n" +
